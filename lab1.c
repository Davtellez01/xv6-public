...
int main(int argc,char *argv[]) 
{
    ...
    if (atoi(argv[1]) == 1) //this is a test
        ...
        printf(1,"\ntype \"lab 1\" to test exit and wait, \"lab1 2\" to test waitpid and \"lab 3\" to test the extra credut WOHANG option\n");
    ...
    int exitWait(void) {
        ...
        printf(1,"\n Part a & b) Testing exit(int status) and wait(int* status)\n");
    ...
    int waitPid(void){
        ...
        // printf(1,"]n Part c) testing waitpid(int pid,int*status,int optionts):\n");
        // for (i = 0; i <5; i++){
        //     pid_a[i] = fork();
        //     if (pid_a[i] == 0){
